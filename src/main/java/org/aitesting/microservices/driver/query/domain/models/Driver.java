package org.aitesting.microservices.driver.query.domain.models;
...
public class Driver {
    ...
    public Driver(UUID id, String fname, String lname, String address, String email, String phone, String license) {
        this.id = id;
        this.fname = fname;
        this.lname = lname;
